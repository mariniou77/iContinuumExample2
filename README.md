...
You need to create the GRE firewall rule on your new project. Go to:
GCP Console → VPC Network → Firewall → Create Firewall Rule
Set:

Name: allow-icontinuum-gre
Direction: Ingress
Targets: All instances in the network (or use a network tag)
Source IP ranges: 10.132.0.0/20
Protocols: Select Other and type 47
Priority: 1000
